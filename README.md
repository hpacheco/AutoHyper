...
The initial declaration defines all variables included in the system and fixes a type for each. 
...
When using option `--nusmv` (or by default), AutoHyper expects symbolic NuSMV system(s).
